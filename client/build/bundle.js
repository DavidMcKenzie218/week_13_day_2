...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChartsContainer = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(ChartsContainer, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Top20Container = __webpack_require__(160);
	
	var ChartsContainer = React.createClass({
	  displayName: 'ChartsContainer',
	  ...
	  handleApiData: function handleApiData(data) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Top20Container, { songs: this.state.songs })
	    );
	  }
	...
	var Top20Container = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var songList = this.props.songs.map(function (song, index) {
	      return React.createElement(Song, { key: index, artist: song["im:artist"].label, title: song["im:name"].label, position: index + 1 });
	    });
